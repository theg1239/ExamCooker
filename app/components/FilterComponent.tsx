...
const Dropdown: React.FC<DropdownProps> = ({ pageType }) => {
    ...
    return (
        <div className="relative inline-block text-left" ref={dropdownRef}>
            ...
            <div className={`hide-scrollbar flex flex-col sm:flex-row sm:space-x-4 justify-center items-start absolute left-0 mt-2 w-full w-[60vw] sm:w-auto sm:max-w-[1200px] border-2 border-black dark:border-white bg-[#4AD0FF] dark:bg-[#232530] z-50 overflow-auto ${isOpen ? '' : 'hidden'}`}>
