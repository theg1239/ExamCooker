...
const Dropdown: React.FC<DropdownProps> = ({ pageType }) => {
  ...
  return (
    <div className="relative inline-block text-left">
      ...
      <div className={`absolute right-0 mt-2 max-w-[90vw] sm:max-w-[400px] md:max-w-[600px] lg:max-w-[1200px] h-auto border-2 border-black bg-[#5FC4E7] overflow-y-auto ${isOpen ? '' : 'hidden'}`}>
        <div className='py-20'>
