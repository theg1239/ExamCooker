        ...
        <div className="relative overflow-hidden p-6 max-w-2xl mx-auto shadow-lg bg-[#C2E6EC] dark:bg-[#0C1222]">
            <div className="flex justify-between items-center mb-6">
                ...
                <button
                    ...
                    <button type="submit" title="Start Quiz" className="dark:text-[#D5D5D5] dark:group-hover:text-[#3BF4C7] dark:group-hover:border-[#3BF4C7]
            ...
            <div className="flex space-x-4 mb-6">
                <div className="w-1/2" ref={dropdownRef}>
                    ...
                    <div className="relative">
                        <button
                            className={`p-3 w-full border text-left flex justify-between items-center bg-white dark:bg-[#3D414E] text-black dark:text-[#D5D5D5] ${validation.weeks.isValid ? "border-gray-300" : "border-red-500"
                                }`}
                            ...
                            <div className="absolute z-10 w-full bg-white dark:bg-[#3D414E] text-black dark:text-[#D5D5D5] border mt-1 shadow-lg overflow-y-auto max-h-48">
                                {Array.from({ length: 12 }, (_, i) => i + 1).map((week) => (
                                    <div
                                        ...
                                        className={`cursor-pointer p-2 hover:bg-black/20 dark:hover:bg-white/20 ${quizState.selectedWeeks.includes(week)
                                                ? "bg-gray-200"
                                                : ""
                                            }`}
                                    >
                ...
                <div className="w-1/2">
                    ...
                    <input
                        ...
                        className={`w-full p-2 border  dark:bg-[#3D414E] text-black dark:text-[#D5D5D5] ${validation.questions.isValid
                                ? "border-gray-300"
                                : "border-red-500"
                            }`}
                        style={{ height: "3rem" }}
            ...
            <div className="flex space-x-4 mb-6">
                <div className="w-1/3">
                    ...
                    <input
                        ...
                        className={`w-full p-2 border dark:bg-[#3D414E] text-black dark:text-[#D5D5D5] ${validation.duration.isValid ? "border-gray-300" : "border-red-500"
                            }`}
                        style={{ height: "3rem" }}
                    />
                </div>
