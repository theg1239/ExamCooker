        ...
        <div className="bg-[#C2E6EC] dark:bg-[#0C1222]  transition-colors ease-in space-y-40 md:space-y-96 text-black dark:text-[#D5D5D5]" >
            ...
            <div className="lg:sticky lg:h-screen lg:top-0 lg:bg-[#C2E6EC] lg:dark:bg-[#0C1222] flex-col content-center">
                ...
                <h4 className="px-1 md:px-16 text-center">
                    Remember the days of desperately searching the web for past
                    papers, only to get lost in a maze of irrelevant links?
                    <br />
                    We do too! Thats why we built this website - a haven for
                    students who are tired of the exam prep struggle.
                    <br />
                    Here, everything you need to cram like a champion is under
                    one roof.
                    <br />{" "}
                    <GradientText>
